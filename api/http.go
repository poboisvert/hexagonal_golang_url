...
import (
	...
	js "github.com/poboisvert/hexagonal_golang_url/serializer/json"
	ms "github.com/poboisvert/hexagonal_golang_url/serializer/msgpack"
...
type handler struct {
	redirectService shortener.RedirectService // redirect service
}

func NewHandler(redirectService shortener.RedirectService) RedirectHandler {
	return &handler{redirectService: redirectService} // passback redirect handler
}
